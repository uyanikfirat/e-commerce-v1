    ...
    <div class="app-sidebar">
        <div class="side-header">
            <a class="header-brand1" href="index.html">
                <img src="dashboard/assets/images/brand/logo-white.png" class="header-brand-img desktop-logo" alt="logo">
                <img src="dashboard/assets/images/brand/icon-white.png" class="header-brand-img toggle-logo"
                    alt="logo">
                <img src="dashboard/assets/images/brand/icon-dark.png" class="header-brand-img light-logo" alt="logo">
                                            ...
                                            <div class="Annoucement_card">
                                                <div class="text-center">
                                                    <div>
                                                        ...
                                                        <div class="bg-layer">
                                                            <img src="dashboard/assets/dashboard/assets/images/media/37.png" alt="img" class="text-center mx-auto">
                                                        </div>
                                        ...
                                        <div class="main-chat-list tab-pane">
                                            <div class="media border-0 px-1 new border-top-0">
                                                <div class="main-img-user online">
                                                    <img alt="" src="dashboard/assets/images/users/5.jpg">
                                                </div>
                                            ...
                                            <div class="media border-0 px-1 new">
                                                <div class="main-img-user">
                                                    <img alt="" src="dashboard/assets/images/users/6.jpg"> <span>3</span>
                                                </div>
                                                <div class="media-body">
                                                    <div class="media-contact-name">
                                            ...
                                            <div class="media border-0 px-1 new">
                                                <div class="main-img-user online"><img alt="" src="dashboard/assets/images/users/9.jpg"></div>
                                                <div class="media-body">
                                                    <div class="media-contact-name">
                                            ...
                                            <div class="media border-0 px-1 new">
                                                <div class="main-img-user"><img alt="" src="dashboard/assets/images/users/4.jpg"></div>
                                                <div class="media-body">
                                                    <div class="media-contact-name">
                                            ...
                                            <div class="media border-0 px-1 new">
                                                <div class="main-img-user"><img alt="" src="dashboard/assets/images/users/21.jpg"></div>
                                                <div class="media-body">
                                                    <div class="media-contact-name">
                                            ...
                                            <div class="media border-0 px-1 new">
                                                <div class="main-img-user"><img alt="" src="dashboard/assets/images/users/5.jpg"></div>
                                                <div class="media-body">
                                                    <div class="media-contact-name">
                                            ...
                                            <div class="media border-0 px-1 new">
                                                <div class="main-img-user"><img alt="" src="dashboard/assets/images/users/3.jpg"></div>
                                                <div class="media-body">
                                                    <div class="media-contact-name">
                                            ...
                                            <div class="media border-0 px-1 new">
                                                <div class="main-img-user"><img alt="" src="dashboard/assets/images/users/7.jpg"></div>
                                                <div class="media-body">
                                                    <div class="media-contact-name">
                                            ...
                                            <div class="media border-0 px-1 new border-bottom-0">
                                                <div class="main-img-user"><img alt="" src="dashboard/assets/images/users/6.jpg"></div>
                                                <div class="media-body">
                                                    <div class="media-contact-name">
