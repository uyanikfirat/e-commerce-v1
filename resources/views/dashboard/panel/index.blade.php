                            ...
                            <div class="browser-stats">
                                <div class="row mb-4">
                                    <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                                        <img src="dashboard/assets/images/browsers/chrome.svg" class="img-fluid"
                                            alt="img">
                                    </div>
                                ...
                                <div class="row mb-4">
                                    <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                                        <img src="dashboard/assets/images/browsers/opera.svg" class="img-fluid"
                                            alt="img">
                                    </div>
                                    <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                                        <div class="d-flex align-items-end justify-content-between mb-1">
                                ...
                                <div class="row mb-4">
                                    <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                                        <img src="dashboard/assets/images/browsers/ie.svg" class="img-fluid" alt="img">
                                    </div>
                                    <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                                        <div class="d-flex align-items-end justify-content-between mb-1">
                                            <h6 class="mb-1">IE</h6>
                                ...
                                <div class="row mb-4">
                                    <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                                        <img src="dashboard/assets/images/browsers/firefox.svg" class="img-fluid"
                                            alt="img">
                                    </div>
                                    <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                                        <div class="d-flex align-items-end justify-content-between mb-1">
                                ...
                                <div class="row mb-4">
                                    <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                                        <img src="dashboard/assets/images/browsers/edge.svg" class="img-fluid"
                                            alt="img">
                                    </div>
                                    <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                                        <div class="d-flex align-items-end justify-content-between mb-1">
                                ...
                                <div class="row mb-4">
                                    <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                                        <img src="dashboard/assets/images/browsers/safari.svg" class="img-fluid"
                                            alt="img">
                                    </div>
                                    <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                                        <div class="d-flex align-items-end justify-content-between mb-1">
                                ...
                                <div class="row">
                                    <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                                        <img src="dashboard/assets/images/browsers/netscape.svg" class="img-fluid"
                                            alt="img">
                                    </div>
                                    <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                                        <div class="d-flex align-items-end justify-content-between mb-1">
                                                            ...
                                                            <tbody>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex">
                                                                            <span class="avatar bradius"
                                                                                style="background-image: url(dashboard/assets/images/orders/10.jpg)"></span>
                                                                ...
                                                                <tr class="border-bottom">
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex">
                                                                            <span class="avatar bradius"
                                                                                style="background-image: url(dashboard/assets/images/orders/12.jpg)"></span>
                                                                            <div class="ms-3 mt-0 mt-sm-2 d-block">
                                                                                <h6 class="mb-0 fs-14 fw-semibold">
                                                                                    Flower Pot</h6>
                                                                            </div>
                                                                ...
                                                                <tr class="border-bottom">
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex">
                                                                            <span class="avatar bradius"
                                                                                style="background-image: url(dashboard/assets/images/orders/4.jpg)"></span>
                                                                            <div class="ms-3 mt-0 mt-sm-2 d-block">
                                                                                <h6 class="mb-0 fs-14 fw-semibold">
                                                                                    Pen Drive</h6>
                                                                            </div>
                                                                ...
                                                                <tr class="border-bottom">
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex">
                                                                            <span class="avatar bradius"
                                                                                style="background-image: url(dashboard/assets/images/orders/8.jpg)"></span>
                                                                            <div class="ms-3 mt-0 mt-sm-2 d-block">
                                                                                <h6 class="mb-0 fs-14 fw-semibold">
                                                                                    New Bowl</h6>
                                                                            </div>
                                                                ...
                                                                <tr class="border-bottom">
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex">
                                                                            <span class="avatar bradius"
                                                                                style="background-image: url(dashboard/assets/images/orders/6.jpg)"></span>
                                                                            <div class="ms-3 mt-0 mt-sm-2 d-block">
                                                                                <h6 class="mb-0 fs-14 fw-semibold">
                                                                                    Leather Watch</h6>
                                                                            </div>
                                                                ...
                                                                <tr class="border-bottom">
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex">
                                                                            <span class="avatar bradius"
                                                                                style="background-image: url(dashboard/assets/images/orders/1.jpg)"></span>
                                                                            <div class="ms-3 mt-0 mt-sm-2 d-block">
                                                                                <h6 class="mb-0 fs-14 fw-semibold">
                                                                                    Digital Camera</h6>
                                                                            </div>
                                                                ...
                                                                <tr class="border-bottom">
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex">
                                                                            <span class="avatar bradius"
                                                                                style="background-image: url(dashboard/assets/images/orders/11.jpg)"></span>
                                                                            <div class="ms-3 mt-0 mt-sm-2 d-block">
                                                                                <h6 class="mb-0 fs-14 fw-semibold">
                                                                                    Earphones</h6>
                                                                            </div>
                                                                ...
                                                                <tr class="border-bottom">
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex">
                                                                            <span class="avatar bradius"
                                                                                style="background-image: url(dashboard/assets/images/orders/2.jpg)"></span>
                                                                            <div class="ms-3 mt-0 mt-sm-2 d-block">
                                                                                <h6 class="mb-0 fs-14 fw-semibold">
                                                                                    Shoes</h6>
                                                                            </div>
